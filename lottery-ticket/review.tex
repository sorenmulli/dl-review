...
In \citeyear{Malach2020ProvingTL}, \acrshort{lth} was theoretically proven for fully-connected ReLU \acrshort{dnn}'s by \texcite{Malach2020ProvingTL} using the theory of random networks.
